...
var _Soundform = require('./Soundform');

var _Soundform2 = _interopRequireDefault(_Soundform);

_react2['default'].render(_react2['default'].createElement(_Soundform2['default'], null), document.getElementById('react'));

},{"./Soundform":162,"react":158}],2:[function(require,module,exports){
...
exports['default'] = (0, _reactLibKeyMirror2['default'])({
    ...
    CHNAGE_TYPE: null,
    CHNAGE_FREQ: null,
    DRAW_TIMEDOMAIN: null,
    DRAW_FREQDOMAIN: null
});
module.exports = exports['default'];

},{"react/lib/keyMirror":143}],160:[function(require,module,exports){
'use strict';
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(
                            'p',
                            null,
                            _react2['default'].createElement('input', { name: 'type', type: 'radio', value: 'sine', checked: true }),
                            _react2['default'].createElement(
                                'label',
                                null,
                                'Sine'
                        ...
                        _react2['default'].createElement(
                            'p',
                            null,
                            _react2['default'].createElement('input', { name: 'type', type: 'radio', value: 'triangle' }),
                            _react2['default'].createElement(
                                'label',
                                null,
                                'Triangle'
                        ...
                        _react2['default'].createElement(
                            'p',
                            null,
                            _react2['default'].createElement('input', { name: 'type', type: 'radio', value: 'sawtooth' }),
                            _react2['default'].createElement(
                                'label',
                                null,
                                'Saw'
                        ...
                        _react2['default'].createElement(
                            'p',
                            null,
                            _react2['default'].createElement('input', { name: 'type', type: 'radio', value: 'square' }),
                            _react2['default'].createElement(
                                'label',
                                null,
                                'Square'
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(
                            ...
                            _react2['default'].createElement('input', { type: 'range', min: '20', max: '1000' })
                        )
                    ),
                    _react2['default'].createElement(
                        'div',
...
exports['default'] = _react2['default'].createClass({
    displayName: 'Soundform',

    render: function render() {
        return _react2['default'].createElement(_ControlPanel2['default'], null);
    }
});
module.exports = exports['default'];

},{"./ControlPanel":160,"react":158}],162:[function(require,module,exports){
'use strict';
...
var _componentsSoundform = require('./components/Soundform');

var _componentsSoundform2 = _interopRequireDefault(_componentsSoundform);

var _storesSoundFormStore = require('./stores/SoundFormStore');

var _storesSoundFormStore2 = _interopRequireDefault(_storesSoundFormStore);

_reactor2['default'].registerStores({
    'soundform': _storesSoundFormStore2['default']
});

exports['default'] = _componentsSoundform2['default'];
module.exports = exports['default'];

},{"../reactor":164,"./components/Soundform":161,"./stores/SoundFormStore":163}],163:[function(require,module,exports){
'use strict';
...
exports['default'] = (0, _nuclearJs.Store)({
    ...
    initialize: function initialize() {
        this.on(_actionTypes.PLAY, this._play);
        // this.on(STOP, updateNode);
        // this.on(CHANGE_FREQ, deleteNode);
        // this.on(CHANGE_TYPE, deleteNode);
    },

    _createOSCNode: function _createOSCNode(type, freq) {
    ...
    _createGainNode: function _createGainNode() {
        return audioContext.createGain();
    },

    _createAnalyserNode: function _createAnalyserNode() {
        return audioContext.createAnalyser();
    },

    _connectNodes: function _connectNodes() {
...
},{"../actionTypes":159,"nuclear-js":3}],164:[function(require,module,exports){
'use strict';
